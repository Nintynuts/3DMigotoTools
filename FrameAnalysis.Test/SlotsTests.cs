...
public class SlotsTests
{
    ...
    public void SlotsMerge()
    {
        ...
        AreEqual(0u, multiSlot.StartSlot);
        AreEqual(8u, multiSlot.NumSlots);
        AreEqual(2, multiSlot1.PointersMerged?.Count);
        AreEqual(2, multiSlot1.MergeWarnings.Count());
    }
    ...
    public void SparseSlotsFallback()
    {
        ...
        AreEqual(10, deferred2.TestSlots.GlobalSlotsMask.Count, "Global Slots Mask");
        AreEqual(10, deferred2.TestSlots.Slots.Count(s => s != null), "Not Null Slots");
    }
    ...
    public void NullSlotsDoNotFallback()
    {
        ...
        AreEqual(10, deferred2.TestSlots.GlobalSlotsMask.Count, "Global Slots Mask");
        AreEqual(10, deferred2.TestSlots.Slots.Count, "Set Slots");
        AreEqual(5, deferred2.TestSlots.Slots.Count(s => s != null), "Not Null Slots");
    }
}
...
internal class TestSlots : MultiSlotBase<TestSlots, TestSlot, TestSlots, TestDeferred, TestDeferred>
{
    ...
    private static readonly List<int> globalSlotsMask = new();
